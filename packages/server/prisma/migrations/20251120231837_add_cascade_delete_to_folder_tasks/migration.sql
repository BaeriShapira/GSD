...
INSERT INTO "new_Task" ("areaOfLifeId", "createdAt", "folderId", "id", "labels", "sortOrder", "status", "text", "userId") SELECT "areaOfLifeId", "createdAt", "folderId", "id", "labels", "sortOrder", "status", "text", "userId" FROM "Task";
DROP TABLE "Task";
