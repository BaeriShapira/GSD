...
INSERT INTO "new_Task" ("areaOfLifeId", "blockedByTaskId", "contextId", "createdAt", "dueDate", "estimatedTime", "expectedDate", "folderId", "id", "labels", "lastNudgedAt", "projectId", "sortOrder", "status", "text", "urgency", "userId", "waitingFor") SELECT "areaOfLifeId", "blockedByTaskId", "contextId", "createdAt", "dueDate", "estimatedTime", "expectedDate", "folderId", "id", "labels", "lastNudgedAt", "projectId", "sortOrder", "status", "text", "urgency", "userId", "waitingFor" FROM "Task";
DROP TABLE "Task";
