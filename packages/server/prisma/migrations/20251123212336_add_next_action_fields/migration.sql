...
INSERT INTO "new_Task" ("areaOfLifeId", "createdAt", "expectedDate", "folderId", "id", "labels", "lastNudgedAt", "sortOrder", "status", "text", "userId", "waitingFor") SELECT "areaOfLifeId", "createdAt", "expectedDate", "folderId", "id", "labels", "lastNudgedAt", "sortOrder", "status", "text", "userId", "waitingFor" FROM "Task";
DROP TABLE "Task";
