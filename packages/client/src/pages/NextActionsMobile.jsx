...
/**
 * Mobile-optimized Next Actions page
 * Simple layout for mobile users to view and manage their next actions
 */
export default function NextActionsMobile() {
    const { tasks, isLoading, isError, error, updateTask } = useTasks("NEXT_ACTION");
    ...
    const filteredTasks = useMemo(() => {
        ...
        // Sort by urgency (highest first), then by due date
        filtered.sort((a, b) => {
        ...
        <div className="min-h-screen bg-brand-bg flex flex-col">
            ...
            <div className="px-2 sm:px-4 pb-2">
                <p className="text-xs sm:text-sm text-black/60 text-center">
                    {filteredTasks.length} {filteredTasks.length === 1 ? 'action' : 'actions'}
