                ...
                <table className="w-full">
                    <thead>
                        <tr className="border-b border-black/10 dark:border-dark-border bg-gray-50 dark:bg-dark-bg">
                            <th className="w-1/4 p-3 pl-6 text-left text-xs font-semibold text-black/60 dark:text-dark-text-secondary uppercase tracking-wider">
                                <button
                                    type="button"
                                    onClick={() => onSort('task')}
                            ...
                            <th className="w-[8%] p-3 text-left text-xs font-semibold text-black/60 dark:text-dark-text-secondary tracking-wider">
                                <div className="flex items-center gap-1">
                                    <button
                                        type="button"
                            ...
                            <th className="w-[10%] p-3 text-left text-xs font-semibold text-black/60 dark:text-dark-text-secondary uppercase tracking-wider">
                                <button
                                    type="button"
                                    onClick={() => onSort('due')}
                                    className="inline-flex items-center gap-1 hover:text-black/80 dark:hover:text-white"
                            ...
                            {sortedTasks.length === 0 ? (
                                <tr>
                                    <td colSpan={8} className="p-6 text-center">
                                        <h2 className="dark:text-white">No next actions</h2>
