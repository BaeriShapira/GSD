...
export default function WaitingForTutorial({ isOpen, onClose, onComplete }) {
    const [currentStep, setCurrentStep] = useState(0);

    const steps = [
        {
            target: null,
            title: "Welcome to Waiting For!",
            content: "Track things you're waiting to receive from others. Don't let important items fall through the cracks!",
            placement: "center",
        },
        {
            target: ".waiting-for-add-button",
            title: "Add Waiting Items",
            content: "Add items you're waiting for - deliverables, responses, documents, or any commitments from others.",
            placement: "left",
            highlight: true,
        },
        {
            target: ".waiting-for-search",
            title: "Track & Organize",
            content: "Search items, group by Area or Project, and keep everything organized in one place.",
            placement: "bottom",
            highlight: true,
        },
        {
            target: null,
            title: "Nudge Them!",
            content: "Use the 'Nudge' button to send a gentle reminder. Keep track of when you last followed up so nothing gets forgotten.",
            placement: "center",
        },
    ];
