...
/**
 * Master Task Card Component - UI component based on DailyTaskCard
 * Shows task with colored left border (by area of life), urgency stars, project name, and actions
 */
export default function MasterTaskCard({ task, onComplete, onEdit, onDelete, onRemove, showTime = false }) {
