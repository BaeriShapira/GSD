...
export default function GTDSection() {
    return (
        <div className="relative z-10 -mt-1.5 py-12 md:py-18 px-4 bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 dark:from-purple-950 dark:via-purple-900 dark:to-indigo-950">
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                    ...
                    <div className="relative flex justify-center items-center order-1 md:order-2">
                        <div className="w-64 h-48 sm:w-80 sm:h-60 md:w-100 md:h-80 lg:w-150 lg:h-120">
